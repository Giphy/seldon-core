...
def add_GenericServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('seldon.protos.Generic', rpc_method_handlers)
...
def add_ModelServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('seldon.protos.Model', rpc_method_handlers)
...
def add_RouterServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('seldon.protos.Router', rpc_method_handlers)
...
def add_TransformerServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('seldon.protos.Transformer', rpc_method_handlers)
...
def add_OutputTransformerServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('seldon.protos.OutputTransformer', rpc_method_handlers)
...
def add_CombinerServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('seldon.protos.Combiner', rpc_method_handlers)
...
def add_SeldonServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('seldon.protos.Seldon', rpc_method_handlers)
